  ...
  <div class="balance">
    ...
    <div class="header">
      ...
      <div class="bal_buttom">
        <div class="balbut_top">
          <span>当前余额</span>
          <!-- 点击跳转 -->
          <span class="el-icon-question">
              <router-link :to="{path:'/balance/detail'}">余额说明</router-link>
              <router-view></router-view>
             </span>
        </div>
        <div class="balbut_middle">
          <!-- 非固定值 -->
          <b>0.00</b>
          <span>元</span>
        </div>
        <div class="balbut_but">
          <mt-button type="default" size="large" class="balbut_but_btn">提现</mt-button>
        </div>
      </div>
    </div>
    <!-- 交易明细区域 -->
