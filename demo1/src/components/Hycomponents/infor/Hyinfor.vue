<template>
  <div class="infor">
    ...
    <ul>
      <router-link :to="{path:'/infor/setusername'}">
        <li class="upload_li1">
          <span>用户名</span>
          <!-- 非固定值 -->
          <span>{{this.$store.state.setUserName}}</span>
    ...
    <el-button type="danger"
               class="quit" @click="leaveLogin">退出登录</el-button>
    <!-- 弹框 -->
    ...
    <div class="leave_pop_up animation bounceIn"
      ...
      <mt-button  type="default" size="small"
                  @click="isShow1=!isShow1">再等等</mt-button>
      <mt-button type="default" size="small"
                 @click="cruel_to_leave">残忍离开</mt-button>
    </div>
  </div>
</template>
...
<style scoped>
  * {
  ...
  .upload_li1 span:nth-child(1) {
    padding-left: 2%;
  }
  .upload_li1 span:nth-child(2) {
  ...
  /* 收货地址 */
  .upload_li2 span:nth-child(1) {
    padding-left: 2%;
  }
  .upload_li2 span:nth-child(2) {
  ...
  .leave_pop_up button:nth-child(5){
